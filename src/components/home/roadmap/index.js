    ...
    <div className="roadmap__information">
      <div className="roadmap__content">
        ...
        <div className="roadmap__right">
          ...
          <RoadmapElement title="Q4 2021" content={content1} />
          <RoadmapElement title="Q1 2022" content={content2} />
          <RoadmapElement title="Q2 2022" content={content3} />
          <RoadmapElement title="Q3 2022" content={content4} />
          <RoadmapElement title="Q4 2022" content={content5} last={true} />
        </div>
      </div>
    </div>
  </section>
