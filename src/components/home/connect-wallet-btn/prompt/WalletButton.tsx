...
import Button from "./wallet-components/Button";
import Column from "./wallet-components/Column";
import Wrapper from "./wallet-components/Wrapper";
import Modal from "./wallet-components/Modal";
import Header from "./wallet-components/Header";
import Loader from "./wallet-components/Loader";
...
class WalBtn extends React.Component<any, any> {
